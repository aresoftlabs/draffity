...
Toda la información que ingresás vive **exclusivamente en tu equipo**
...
- Imágenes y fuentes que subís a un proyecto (carpeta `media/`).
...
- **Telemetría de uso**: no enviamos qué botones tocás ni cuántas
  veces abrís la app.
- **Crash reports**: por defecto están desactivados. Si los activás
...
Draffity usa estos componentes que pueden tocar la red sólo si vos
los invocás:

- **Tauri Shell**: abrir archivos exportados con el navegador o
  editor predeterminado.
- **Tauri Dialog**: file pickers nativos del sistema.
- **Tauri FS**: leer/escribir archivos en rutas que vos elegís.

Ninguno de ellos transmite datos sin una acción tuya.

## Tu derecho a borrar

Para eliminar todos los datos de Draffity borrá la carpeta
...
Bugs y consultas sobre privacidad: abrí una issue en el repositorio
de Draffity.
